...
namespace TwentyTwenty.BaseLine.RateLimiting
{
    ...
    public static class TokenBuckets
    {
        ...
        {
            public async Task Sleep(CancellationToken cancellationToken)
            {
                await Task.Yield();
        ...
        // This SleepStrategy can be enabled if we move this library to Netstandard 2.0.  Thread.SpinWait is not available in 1.3
